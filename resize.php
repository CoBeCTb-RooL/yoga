...
if (eregi('\.(jpeg|jpg)$', $file)) imagejpeg($image, '', 100);
if (eregi('\.(gif)$', $file)) imagegif($image, '', 100);
if (eregi('\.(png)$', $file)) imagepng($image, '', 100);
if (eregi('\.(bmp)$', $file)) imagewbmp($image, '', 100);
